...
import com.javadeveloperblogs.app.ws.io.Repository.AuthorityRepository;
...
public class InitialUsersSetup {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        adminUser.setFirstName("Nasim");
        adminUser.setLastName("Sarwar");
        adminUser.setEmail("admin@javadeveloperblogs.com");
        adminUser.setEmailVerificationStatus(true);
        adminUser.setUserId(utils.generateUserId(30));
        adminUser.setEncryptedPassword(bCryptPasswordEncoder.encode("12345678"));
        adminUser.setRoles(Arrays.asList(roleAdmin));

        UserEntity storedUserDetails = userRepository.findByEmail("admin@javadeveloperblogs.com");
